...
Coordinates match WBCACCModel: root translation/quaternion XYZW, local root twist.
"""
import json
from pathlib import Path
import torch

MODEL_PATH = Path(__file__).resolve().parents[1]/'assets/booster/t1/wbc_acc_dynamics.json'
