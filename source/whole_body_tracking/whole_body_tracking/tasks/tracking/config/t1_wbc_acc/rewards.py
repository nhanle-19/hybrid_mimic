"""WBCACC rewards evaluated at policy rate using physical QP/contact quantities."""
import torch


def qp_failed(env, action_name='wbc_acc'):
    """Any invalid/infeasible solve since reset, including earlier decimation steps."""
    return env.action_manager.get_term(action_name).qp_failed
