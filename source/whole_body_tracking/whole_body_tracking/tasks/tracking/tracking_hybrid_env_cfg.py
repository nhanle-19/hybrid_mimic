...
class EventCfg:
    ...
    physics_material = EventTerm(
        ...
        params={
            ...
            "static_friction_range": (0.3, 0.99),
    ...
    randomize_ankle_d = EventTerm(
        ...
        params={
            ...
            "damping_distribution_params": (-0.5, 7.0),
            "operation": "add",
...
class RewardsCfg:
    ...
    action_rate_l2 = RewTerm(func=mdp.hybrid_action_rate_l2, weight=-8e-2)
    joint_limit = RewTerm(
    ...
    force_correctness = RewTerm(
        func=mdp.hybrid_force_correctness,
        weight=0.15,
        params={
            "sensor_cfg": SceneEntityCfg("contact_forces"),
        }
    ...
    #tau_ref = RewTerm(
    #    func=mdp.hybrid_tau_ref,
    #    weight=0.1,
    #    params = {}
    #)
    tau_limit = RewTerm(
        func=mdp.hybrid_tau_limit,
        weight=-0.1,
        params = {}
    )
...
@configclass
class TrackingHybridEnvCfg(ManagerBasedRLEnvCfg):
...
@configclass
class TrackingHybridEnvEvalCfg(ManagerBasedRLEnvCfg):
    """Configuration for the locomotion velocity-tracking environment."""
