"""Export the T1 USD rigid-body tree for the independent WBCACC dynamics model.
...
def main():
    ...
    parser.add_argument('--output', type=Path, default=root/'source/whole_body_tracking/whole_body_tracking/assets/booster/t1/wbc_acc_dynamics.json')
